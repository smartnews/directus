import { API_INJECT, EXTENSIONS_INJECT, STORES_INJECT } from '@smartnews/directus-constants';
import type { AppExtensionConfigs, RefRecord } from '@smartnews/directus-types';
