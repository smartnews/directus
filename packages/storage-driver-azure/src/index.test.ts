...
import { normalizePath } from '@smartnews/directus-utils';
import { isReadableStream } from '@smartnews/directus-utils/node';
...
vi.mock('@smartnews/directus-utils/node');
vi.mock('@smartnews/directus-utils');
