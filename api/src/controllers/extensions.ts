import { EXTENSION_TYPES } from '@smartnews/directus-constants';
import type { Plural } from '@smartnews/directus-types';
import { depluralize, isIn } from '@smartnews/directus-utils';
