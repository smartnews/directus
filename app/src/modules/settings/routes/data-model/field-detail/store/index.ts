...
import { InterfaceConfig, DisplayConfig, DeepPartial, Field, Relation, Collection, LocalType } from '@smartnews/directus-types';
import { LOCAL_TYPES } from '@smartnews/directus-constants';
